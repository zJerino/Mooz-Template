    ...
    if (page === 'status') {
        ...
        $(document).ready(() => {
            ...
            if (math33t >= 0) {
                ...
                temp1.parentElement.style.paddingLeft = 'calc(3rem + ' + ((math33t - (temp1.clientWidth / 2)) * 0.11428571428571428) + 'rem' + ')'
            } else {
                temp1.parentElement.style.paddingLeft = 'calc(3rem + ' + (math33t) + 'px)'
            }
        })
